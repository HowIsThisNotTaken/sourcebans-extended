...
sourcebans.SetConfig("hostname", "taken.hosted.nfoservers.com");       -- Database Hostname
sourcebans.SetConfig("username", "kjhernandez");            -- Database Login name
sourcebans.SetConfig("password", "cuEmpG7CPf");                -- Database Login Password
sourcebans.SetConfig("database", "kjhernandez_sourcebans");      -- Database 'database' or 'schema' selection
...
sourcebans.SetConfig("website", "ur mom gae"); -- The URL where people can find your sourcebans install (Do not put http:// or the kick reason will break!)
